            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">领用记录登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="astrictNum" name="astrictNum" class="form-control"
                                                   v-model="ruleForm.astrictNum" readonly>
                                        </div>
                                ...
                                <input id="goodsId" name="goodsId" v-model="ruleForm.goodsId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="num" name="num" class="form-control"
                                               v-model="ruleForm.num" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>领用时间</label>
                                        <input id="lingyongTime" name="lingyongTime" class="form-control"
                                               v-model="ruleForm.lingyongTime" readonly>
                                    </div>
