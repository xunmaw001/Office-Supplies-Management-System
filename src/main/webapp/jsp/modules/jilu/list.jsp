    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">领用记录管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">领用记录列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">领用记录列表</h3>
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        //领用时间
        var lingyongTimeCell = document.createElement('td');
        lingyongTimeCell.innerHTML = item.lingyongTime;
        row.appendChild(lingyongTimeCell);
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("jilu/delete", "POST", paramArray, (res) => {
                if(res.code == 0){
                    getDataList();
                    alert('删除成功');
                }
    ...
    //添加
    function add() {
        window.sessionStorage.setItem("addjilu", "addjilu");
        window.location.href = "add-or-update.jsp"
    }
