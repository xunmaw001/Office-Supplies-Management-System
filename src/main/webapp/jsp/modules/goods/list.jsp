            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">领用物资设置</h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input id="num" placeholder="请输入要领用的物资数量" class="form-control"/>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" id="receive" class="btn btn-primary">领用</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        //限制领用数量
        var astrictNumCell = document.createElement('td');
        astrictNumCell.innerHTML = item.astrictNum;
        row.appendChild(astrictNumCell);
        ...
        var deleteAttr = 'fuzhi(' + item.id + ')';
        detailBtn.setAttribute("type", "button");
        detailBtn.setAttribute("class", "btn btn-info btn-sm 领用");
        detailBtn.setAttribute("data-toggle", "modal");
        detailBtn.setAttribute("data-target", "#exampleModal");
        detailBtn.setAttribute("onclick", deleteAttr);
        detailBtn.innerHTML = "领用物资"
    ...
    // 发布
    function renting(num,ids) {
        var mymessage = confirm("真的要领取"+num+"个吗？");
        if (mymessage == true) {
            http("goods/renting?num="+num+"&ids="+ids, "get", {}, (res) => {
            if(res.code == 0){
                getDataList();
                alert('领取成功');
